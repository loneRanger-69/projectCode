...
export default function Fields() {
    ...
    const handleEditField = async (e) => {
        ...
        setError(null); // Fehler zurücksetzen
        try {
            await axios.put(`http://localhost:5000/fields/${editField.id}`, editField);
    ...
    const handleAddField = async (e) => {
        ...
        setError(null); // Fehler zurücksetzen
        try {
            await axios.post("http://localhost:5000/fields", newField);
                    ...
                    <>
                        ...
                        {editField && (
                            <div className="bg-white p-4 shadow rounded mb-4">
                                ...
                                <form onSubmit={handleEditField}>
                                    <div className="mb-2">
                                        <label className="block text-sm font-medium text-black">Feldname:</label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="mb-2">
                                        <label className="block text-sm font-medium text-black">Größe (ha):</label>
                                        <input
                                            type="number"
                        ...
                        {newField && (
                            <div className="bg-white p-4 shadow rounded mb-4">
                                ...
                                <form onSubmit={handleAddField}>
                                    ...
                                    <div className="mb-2">
                                        <label className="block text-sm font-medium text-black">pH-Wert:</label>
                                        <input
                                            type="number"
                                            step="0.1"
                                            value={newField.ph || ""}
                                    ...
                                    <div className="mb-2">
                                        <label className="block text-sm font-medium text-black">Feuchtigkeit:</label>
                                        <input
                                            type="number"
                                            step="0.1"
                                    ...
                                    <div className="mb-2">
                                        <label className="block text-sm font-medium text-black">Nährstoffe
                                            (g/m²):</label>
                                        <input
                                            type="number"
                                            step="0.1"
                        ...
                        {!newField && (
                            <div className="flex justify-center mt-4">
                                <button
                                    onClick={() =>
                                        setNewField({name: "", size: 0, status: "", ph: 0, moisture: 0, nutrients: 0})
                                    }
